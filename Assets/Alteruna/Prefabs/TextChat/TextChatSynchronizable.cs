...
namespace Alteruna
{
	public class TextChatSynchronizable : Synchronizable
	{
		...
		private void ConfigCommand(ref bool config, string[] args)
		{
			if (args.Length == 0)
			{
				// Get current value.
			...
			else
			{
				...
				string[] trueStr = new string[] {"TRUE", "1", "ON"};
				...
				string[] falseStr = new string[] {"FALSE", "0", "OFF"};
		...
		public override string ToString()
		{
			...
			{
				_sb.AppendLine(_chat[i].ToString(this));
			}
